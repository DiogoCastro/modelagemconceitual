...
import com.diogoneves.cursomc.dto.CategoriaDTO;
...
public class CategoriaResource {
	...
	public ResponseEntity<Void> update(@Valid @RequestBody CategoriaDTO objDto, @PathVariable Integer id) {  // Combinação dos dois últimos, com @RequestBody e @PathVariable
		Categoria obj = service.FromDTO(objDto);
		obj.setId(id);
