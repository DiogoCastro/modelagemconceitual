...
import com.diogoneves.cursomc.dto.ProdutoDTO;
import com.diogoneves.cursomc.resources.utils.URL;
import com.diogoneves.cursomc.services.ProdutoService;

@RestController
@RequestMapping(value="/produtos")  //o value é o nome do endpoint
